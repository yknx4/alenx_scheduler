...
ActiveRecord::Schema.define(version: 20_161_019_174_733) do
  ...
  create_table 'user_services', force: :cascade do |t|
    ...
    t.index %w(user_id service_id), name: 'index_user_services_on_user_id_and_service_id', unique: true, using: :btree
